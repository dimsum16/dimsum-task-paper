...
\end{tikzpicture}
\caption{A \textsc{Reviews} sentence with MWE annotations. 
%Strong links are depicted with solid arcs, and weak links with dotted arcs. 
Precision of the top annotation relative to the bottom one is $1/2$. %with weak links removed 
