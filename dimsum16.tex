...
The annotator was trained by the first author of this paper  
...
For the Ritter tweets in the training set,
the first author independently annotated 6~sets of 11~sentences, spaced out across annotation batches. 
Inter-annotator agreement (IAA) estimates for these sets ranged from 60\% to 75\% $F_1$ for MWEs, and 
