...
The inventory originates from the top-level organization of WordNet,
...
\longversion{To facilitate joint sequence modeling, 
...
\nss{NEEDS UPDATE: Annotators found approximately 3,500~MWEs, 9,000~noun expressions, 8,000~main verb expressions, and 1,000~auxiliary verbs. 
(\Cref{tbl:reviews} offers a more detailed breakdown.)
15\% of MWEs contain a gap.\finalversion{\nss{proportion strong/weak}}} 
...
(\textsc{Reviews} or \textsc{Tweets}); systems could make use of this information as they wish, 
