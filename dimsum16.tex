...
Nine systems participated; the best scored 57\% $F_1$ in a multi-domain evaluation setting, 
...
POS tags also accommodate unseen words, and adapt readily to new text genres.
These factors together, indicate a representation which achieves \emph{broad coverage}. 

Explicit analysis of lexical semantics, by contrast, has been more difficult to scale 
to broad coverage. The problems lie with their comprehensiveness and extensibility.
...
To address this shortcoming, in the DiMSUM~2016 shared task,\footnote{\url{http://dimsum16.github.io/}} we challenged participants to analyze the lexical semantics of English sentences with a tagset integrating
...
% footnote in caption of tbl:annotateddata
\footnotetext{Additional statistics that are relatively consistent across domains: 
...
% \footnote{All~6 documents
% include the following language pairs: en-\{ar,de,es,fa,he,it,ko,nl,th,vi,zh\}. 
% 2~documents include the en-fr pair (also part of IWSLT~2014). 
% all
% en-{hi,ko}
% 69, 129 only
% en-fr
% 1161, 1176, 1353, 1371 only
% en-cs
% https://wit3.fbk.eu/mono.php?release=2012-02&tinfo=cleanedhtml_ted}
...
>>>>>>> 5b6957ea819e89b3f5016da3b229d4a1c8b1e0eb
...
of each supersense in each of the three domains. We use the \dataset{Reviews} domain as base frequency: in comparison, 
the x-axis is the supersense's occurrence rate in the \dataset{Tweets} domain \emph{over and above} 
...
\dirk{What? This is really confusing: don't they just show the relative difference? Why is one more and the other one less?}
