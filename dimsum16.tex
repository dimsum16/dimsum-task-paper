...
Data sets from various sources and existing pre-annotation. Add POS tags and baseline supersenses, corrected by annotator.
...
\paragraph{Test}
We also used 600 sentences (11,279 tokens) from the online review site Trustpilot. The resource generally was described in \citet{hovy-2015trustpilot} and the data set in \citet{hovy-2015age}. The reviews were chosen to control for age, gender, and location, and contained gold POS tags. The data was further annotated for supersenses and MWE by 
